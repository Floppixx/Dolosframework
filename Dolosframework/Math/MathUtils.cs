namespace Dolosframework.Math
{
    ...
    public static class MathUtils
    {
        ...
        public static double AngleInXY(this Vector3 From, Vector3 To) => System.Math.Atan2(To.Y - From.Y, To.X - From.X) % System.Math.PI;
        ...
        public static Vector3 Project(this Vector3 From, float InXY, float FromXY, float Distance) => new Vector3(
            ...
            (float)System.Math.Sin(FromXY) * Distance + From.Z);
        ...
        /// <returns></returns>
        public static Vector3 SmoothAngle(this Vector3 src, Vector3 dest, float smoothAmount) => src + (dest - src) * smoothAmount;
        ...
        /// <returns></returns>
        public static bool PointInCircle(this Vector2 point, Vector2 circleCenter, float radius) => (point - circleCenter).Length() < radius;
